...
ALLOWED_ORIGINS = os.environ.get('ALLOWED_ORIGINS', 'http://localhost:3000,https://671c018a7bbe970008cc8133--dashboard-podologie.netlify.app,https://backend-podologie-production.up.railway.app').split(',')
